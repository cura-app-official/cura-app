...
const MOCK_OWN_LISTINGS = MOCK_ITEMS.filter((i) => i.seller_id === MOCK_PROFILE.id);
      ...
      <FlatList
            ...
            <View style={{ height: HERO_HEIGHT }} className="relative">
              ...
              <View className="absolute bottom-20 left-0 right-0 items-center px-6">
                ...
                {displayProfile.instagram_link && (
                  <Pressable
                    onPress={() => Linking.openURL(displayProfile.instagram_link!)}
                    className="flex-row items-center gap-1.5 mt-2"
                  >
                    <Text className="text-base font-helvetica text-white/70">
                      @{displayProfile.username}
                    </Text>
                  </Pressable>
                )}
        ...
        ListEmptyComponent={
          <View className="items-center py-12 px-8">
            <Text className="text-base font-helvetica text-muted-foreground text-center leading-6">
